...
import { TfooterItem } from "@portfolio/constants";
import { LinkHover, TextMask } from "@portfolio/animation";
			...
			<div className="flex items-center justify-between flex-col h-full">
				...
				<div className="flex items-center justify-center flex-col gap-y-[10px] w-full h-auto ">
					...
					<motion.div
						...
						<Link
							href={"mailto:vemperor8848@gmail.com?subject=Portfolio%20Website"}
							className="uppercase text-[25px] text-[#202020] tracking-wider font-semibold">
							vemperor8848@gmail.com
						</Link>
					</motion.div>
				</div>
